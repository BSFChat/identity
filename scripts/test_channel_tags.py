...
class ImageTags(unittest.TestCase):
    IMAGE = "ghcr.io/bsfchat/identity"
    ...
    def test_newest_stable_pushes_every_moving_tag(self):
        self.assertEqual(
            ...
            [
                "ghcr.io/bsfchat/identity:0.0.44",
                "ghcr.io/bsfchat/identity:0.0",
                "ghcr.io/bsfchat/identity:latest",
                "ghcr.io/bsfchat/identity:latest-beta",
            ],
        )
    ...
    def test_rc_pushes_only_its_own_tag_and_beta(self):
        self.assertEqual(
            ...
            [
                "ghcr.io/bsfchat/identity:0.0.45-rc.1",
                "ghcr.io/bsfchat/identity:latest-beta",
            ],
        )
    ...
    def test_hotfix_on_old_line_pushes_only_its_own_tag(self):
        ...
        self.assertEqual(
            ...
            [
                "ghcr.io/bsfchat/identity:1.2.4",
                "ghcr.io/bsfchat/identity:1.2",
            ],
        )
    ...
    def test_superseded_patch_does_not_take_the_line_tag(self):
        self.assertEqual(
            ...
            ["ghcr.io/bsfchat/identity:1.2.3"],
        )
